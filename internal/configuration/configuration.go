...
type ToolchainSettings struct {
	Targets map[string]TargetSettings `yaml:"targets,omitempty"`
	Configs map[string]ConfigSettings `yaml:"configs,omitempty"`
...
type Settings struct {
	...
	Toolchain ToolchainSettings        `yaml:"toolchain,omitempty"`
