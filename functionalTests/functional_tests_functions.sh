...
test_global_config_show() {
    ...
    local result=$(corteca config get toolchain.default)
    assert_test_equal "corteca config get toolchain.default" "${result}" "armv8" 
}
...
test_user_config_show() {
    ...
    local result=$(corteca config get toolchain.default)
    assert_test_equal "corteca config get toolchain.default" "${result}" "foobar" 
}
